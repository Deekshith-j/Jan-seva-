          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                {language === 'mr' ? 'जनसेवा बद्दल' : 'About JanSeva'}
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {language === 'mr'
                  ? 'जनसेवा हे महाराष्ट्र शासनाचे AI-संचालित डिजिटल टोकन आणि रांग व्यवस्थापन प्रणाली आहे. आम्ही नागरिकांना सरकारी कार्यालयांमध्ये लांब रांगांपासून मुक्त करण्यासाठी आणि त्यांचा वेळ वाचवण्यासाठी कटिबद्ध आहोत.'
                  : 'JanSeva is Maharashtra Government\'s AI-powered digital token and queue management system. We are committed to freeing citizens from long queues at government offices and saving their valuable time.'}
              </p>
            </div>
          </div>
        </section>
